...
/**
 * Appwrite Cloud connection settings for the "quranify" project.
 *
 * Fill in [ENDPOINT] and [PROJECT_ID] from the Appwrite Console
 * (Console > quranify project > Settings). The endpoint has the form
...
object AppwriteConfig {
    const val ENDPOINT = "https://YOUR-REGION.cloud.appwrite.io/v1" // TODO paste
    const val PROJECT_ID = "PASTE-PROJECT-ID" // TODO paste
     ...
     */
    const val OAUTH_REDIRECT_SCHEME = "quranify"

    /** `quranify://auth` — success/failure redirect target for OAuth2. */
